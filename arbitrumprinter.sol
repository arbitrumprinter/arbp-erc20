...
// https://t.me/arbitrumprinter
// https://arbitrumprinter.com
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      // Mainnet
      rewardTokens.push(address(0x912CE59144191C1204E64559FE8253a0e49E6548)); // ARB - Mainnet  
...
contract ArbPrinter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ArbPrinter", "ARBp") {
    	...
    	operationsWallet = address(0x206CB844a095B0933A14831eDE2B11918D1aA97E); // set as operations wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x206CB844a095B0933A14831eDE2B11918D1aA97E),
            block.timestamp
        );
